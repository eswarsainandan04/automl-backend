...
class NumberSystemsPattern(BasePattern):
    ...
    def detect(self, values) -> float:
        ...
        # Roman detection must be fully consistent. If any value looks Roman-valid
        # but the whole non-null set is not Roman-valid, skip number_systems.
        if roman_valid_count > 0 and roman_valid_count < total:
            return 0.0
