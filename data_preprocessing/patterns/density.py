...
class DensityPattern(BasePattern):
    ...
    regex_patterns = [
        ...
        r'^\d+(?:\.\d+)?\s*(?:g/cm3|g/cm³)$',
        r'^\d+(?:\.\d+)?\s*(?:g/ml|g/mL)$',
        r'^\d+(?:\.\d+)?\s*(?:lb/ft3|lb/ft³)$',
    ]
    
    CONVERSIONS = {
        'kg/m3': 1, 'kg/m³': 1,
        'g/cm3': 1000, 'g/cm³': 1000,
        'g/ml': 1000, 'g/ml': 1000,
        'lb/ft3': 16.0185, 'lb/ft³': 16.0185,
    }
    ...
    def normalize(self, values):
        ...
        if unit_counts:
            ...
            self.detected_unit = 'kg/m3'
            most_common_unit = 'kg/m3'
        ...
        def convert_to_target_unit(data_tuple):
            ...
            value_in_kgm3 = number * self.CONVERSIONS[unit]
            value_in_target = value_in_kgm3 / target_conversion
