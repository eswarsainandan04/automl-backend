...
data for a dataset. Read it carefully before deciding which charts to produce & also for categorical columns should produce bar/pie charts for every column if present.
